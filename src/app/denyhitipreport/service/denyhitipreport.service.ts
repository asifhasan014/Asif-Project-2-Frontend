...
const uriGetDataforDeny=Constants.apiUrl+ "/fsadisplaysecuritypolicyruleall/getDataforDeny";

@Injectable({
  providedIn: 'root'
})
export class DenyhitipreportService {
  ...
  getDataforDeny(params_from, param_to,unique_code ): Observable<ApiResponse>{
    const postObj = {
      fromDate: params_from,
      toDate: param_to,
      uniqueCode: unique_code
    }
		return this.httpbase.postData(uriGetDataforDeny, postObj);
  }
