...
import { MwserviceqosdashboardconfigurationService } from "src/app/mwserviceqosdashboardconfiguration/service/mwserviceqosdashboardconfiguration.service";
import { ShowvalidationinfoService } from "src/app/showvalidationinfo/service/showvalidationinfo.service";
import { Mwserviceqosdashboardconfiguration } from "src/app/Mwserviceqosdashboardconfiguration/dto/mwserviceqosdashboardconfiguration";
...
@Component({
   selector: "app-mwserviceqosdashboardgrid",
   templateUrl: "./mwserviceqosdashboardgrid.component.html",
   styleUrls: ["./mwserviceqosdashboardgrid.component.css"],
})
export class MwserviceqosdashboardgridComponent implements OnInit {
   gridOptions: GridOptions;
   mwserviceqosdashboards: Mwserviceqosdashboard[];
   mwserviceqosdashboardList$;
   ...
   chartconfigurations: Mwserviceqosdashboardconfiguration[];
   ...
   vendorWiseConfiguredData: Mwserviceqosdashboardconfiguration;
   topNConfiguredData: Mwserviceqosdashboardconfiguration;
   trajectoryData: Mwserviceqosdashboardconfiguration;
   piechartData: Mwserviceqosdashboardconfiguration;
   categoryWisePieConfiguredData: Mwserviceqosdashboardconfiguration;
   ...
   constructor(
      ...
      private chartconfigurationService: MwserviceqosdashboardconfigurationService,
      ...
      //this.mwserviceqosdashboardList$ = this.mwserviceqosdashboardService.getMwserviceqosdashboardList();
      this.mwserviceqosdashboardList$ = this.mwserviceqosdashboardService.getMwserviceqosdashboardsByUniqueCodeAndDate(
         this.mwserviceqosdashboard.uniqueCode,
         from,
         to
      );
      ...
      this.chartconfigurationService
         .getMwserviceqosdashboardconfigurationList()
      ...
      this.gridOptions = <GridOptions>{
         ...
         onGridReady: () => {
            this.mwserviceqosdashboardList$
               .pipe(
                  catchError((err) => {
               ...
               .subscribe((apiResponse) => {
                  ...
                  this.loadMwserviceqosdashboardsIntoArray(apiResponse);
                  // the initial full set of data
                  // note that we don't need to un-subscribe here as it's a one off data load
                  if (this.gridOptions.api) {
                     // can be null when tabbing between the examples
                     this.gridOptions.api.setRowData(
                        this.mwserviceqosdashboards
                     );
                  }
                  this.showSpinner = false;
               });
         ...
         onCellClicked: (event) => {
            if (event.column.getColId() === "editAction") {
               ...
               router.navigate(["/mwserviceqosdashboards/" + selectedItemId]);
            }
         },
         /*onSelectionChanged: () => {
				var selectedRows = this.gridOptions.api.getSelectedRows();
   ...
   initialLoadingVendorWiseBarChart() {
      if (this.vendorWiseConfiguredData != undefined) {
         ...
         this.mwrVendorWiseBarChartList$ = this.mwserviceqosdashboardService.getdashboardsBarChartByUniqueCodeAndDateCustom(
            this.mwserviceqosdashboard.uniqueCode,
            from,
            to,
   ...
   initialLoadingTopNBarChart() {
      if (this.topNConfiguredData != undefined) {
         ...
         this.mwTopNList$ = this.mwserviceqosdashboardService.getMwTopNBarChart(
            this.mwserviceqosdashboard.uniqueCode,
            from,
            to,
   ...
   initialLoadingTrajectoryChart() {
      if (this.trajectoryData != undefined) {
         ...
         this.mwTrajectoryList = this.mwserviceqosdashboardService.getTrajectoryAnalysis(
            this.mwserviceqosdashboard.uniqueCode,
            from,
            to,
   ...
   initialLoadingPieChart() {
      if (this.piechartData != undefined) {
         ...
         this.mwZoneAlarmList = this.mwserviceqosdashboardService.getZoneWisePieChart(
            this.mwserviceqosdashboard.uniqueCode,
            from,
            to,
   ...
   initialLoadingForCategoryWisePieChart() {
      if (this.categoryWisePieConfiguredData != undefined) {
         ...
         this.mwCategoryWisePieChart = this.mwserviceqosdashboardService.getCategoryWisePieChart(
            this.mwserviceqosdashboard.uniqueCode,
            from,
            to,
  ...
  apiData.forEach((element) => {
   ...
   private loadMwserviceqosdashboardsIntoArray(apiResponse) {
      if (!apiResponse.success) {
         return;
      }

      this.mwserviceqosdashboards = apiResponse.data.map((obj) => {
         var rObj = <Mwserviceqosdashboard>{
            componentId: obj.componentId,
            status: obj.status,
            version: obj.version,
   ...
   onAddMwserviceqosdashboard() {
      this.router.navigate(["/mwserviceqosdashboards/-1"]);
   }

   /* searchByParams(){
		this.showSpinner =true;
		this.mwserviceqosdashboardList$ = this.mwserviceqosdashboardService.getMwserviceqosdashboardsByUniqueCode(this.mwserviceqosdashboard.uniqueCode);
		this.mwserviceqosdashboardList$.pipe(
		      catchError(err => {
		        this.alertService.error(err);
		        this.showSpinner = false;
		        return throwError(err);
			...
			apiResponse => {
				...
				if (this.gridOptions.api) { // can be null when tabbing between the examples
					this.gridOptions.api.setRowData(this.mwserviceqosdashboards);
				}
				this.showSpinner =false;
			}
			);
   ...
   downloadReport() {
      ...
      if (from.length > 0 || to.length > 0) {
         ...
         let finalRequestParam =
            ...
            "&toTime=" +
            toTime;
         this.mwserviceqosdashboardService
            ...
            .subscribe(
               (response) => {
                  ...
                  saveAs(blob, "mwserviceqosdashboard Report.csv");
                  this.showSpinner = false;
               },
               (err) => {
         ...
         let finalRequestParam1 =
            "?uniqueCode=" + this.mwserviceqosdashboard.uniqueCode;
         this.mwserviceqosdashboardService
